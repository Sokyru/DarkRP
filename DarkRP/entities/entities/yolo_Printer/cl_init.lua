...
function ENT:Draw()
	...
	local TextWidth = surface.GetTextSize("Yolo_printer")
	local TextWidth2 = surface.GetTextSize(owner)

	Ang:RotateAroundAxis(Ang:Up(), 90)

	cam.Start3D2D(Pos + Ang:Up() * 11.5, Ang, 0.11)
		draw.WordBox(2, -TextWidth*0.5, -30, "Gold plated printer", "HUDNumber5", Color(255, 215, 0, 100), Color(255,255,255,255))
