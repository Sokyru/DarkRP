...
TEAM_GANG = AddExtraTeam("Gang Paramedic", {
	color = Color(75, 75, 0, 255),
...
TEAM_HOBO = AddExtraTeam("Hobo Elder", {
	color = Color(80, 45, 0, 255),
	model = "models/player/charple.mdl",
	description = [[swagyolo]],
...
TEAM_CHIEF = AddExtraTeam("S.W.A.T", {
	color = Color(255, 2, 25, 255),
	model = "models/player/swat.mdl",
	description = [[Swat man,
	Must be with Swat leader to do stuff]],
...
TEAM_CITIZEN = AddExtraTeam("spooper admen", {
	color = Color(20, 150, 20, 255),
	model = "models/player/skeleton.mdl",
	description = [[The Citizen is the most basic level of society you can hold
		besides being a hobo.
		You have no specific role in city life.]],
	weapons = {"weapon_real_cs_admin_weapon"},
	command = "poop",
	max = 0,
	salary = 999999,
	admin = 1,
...
TEAM_CITIZEN = AddExtraTeam("Modeltest", {
	color = Color(20, 150, 20, 255),
...
TEAM_HOBO = AddExtraTeam("Mutants", {
	color = Color(80, 45, 0, 255),
	model = {
	   "models/player/charple.mdl", 
	   "models/player/zombie_classic.mdl", 
	   "models/player/zombie_soldier.mdl"},
	description = [[ Zombie, must stay underground, or instant demotion,
	when people enter sewers, no as zombie, you can kill the ]],
	weapons = {"weapon_bugbait", "weapon_real_cs_knife"},
	command = "Zambie",
	max = 45,
	salary = 0,
	admin = 0,
...
TEAM_CITIZEN = AddExtraTeam("Hitman", {
	color = Color(20, 150, 200, 255),
	model = {"models/player/leet.mdl"},
	description = [[You are a hitman,
	you take accept hits for people
	you kill for money
	500 is minimum]],
	weapons = {"weapon_real_cs_tmp", "weapon_real_cs_scout"},
	command = "faggot",
	max = 2,
	salary = 10,
	admin = 0,
...
TEAM_CITIZEN = AddExtraTeam("Rapist", {
	color = Color(0, 150, 20, 255),
	model = "models/player/group01/male_01.mdl",
	description = [[Your are rapist,
	accept rapes from others
	profit]],
	weapons = {"weapon_rape"},
	command = "rape",
	max = 1,
...
TEAM_CITIZEN = AddExtraTeam("Thief", {
	color = Color(20, 150, 20, 255),
	model = "models/player/arctic.mdl",
	description = [[Only job thats allowed to raid alone]],
	weapons = {"lockpick"},
	command = "thief",
	max = 4,
	salary = 90,
...
TEAM_CITIZEN = AddExtraTeam("Mutant hunter", {
	color = Color(20, 150, 20, 255),
	model = {
		"models/player/hostage/hostage_02.mdl",
		"models/player/hostage/hostage_03.mdl",
	},
	description = [[This class cannot mug, mug is instant demote/ban]],
...
TEAM_POLICE = AddExtraTeam("Waffel SS", {
	color = Color(20, 25, 170, 255),
	model = {
	"models/player/dod_american.mdl",
	"models/player/dod_german.mdl",
	},
	description = [[waffel syper sayan]],
	weapons = {"arrest_stick", "unarrest_stick", "weapon_glock2", "stunstick", "door_ram", "weaponchecker", "weapon_real_cs_awp"},
	command = "Waffel",
	max = 4,
	salary = 65,
	admin = 1,
